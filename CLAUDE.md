...
Node.js 26 (published floor 24) + TypeScript + Ink TUI. Five AI provider backends (Claude Code / GitHub Copilot / OpenAI Codex /
...
Requirements: contributors get Node 26 + pnpm 12 from `mise.toml`; the published package supports Node 24+
(`engines.node`). One of the supported AI CLIs in PATH and authenticated.
