...
- [seams_implement_prologue_gates.md](seams_implement_prologue_gates.md) — Dirty-tree menu before setup + in-leaf post-setup check; e2e porcelain counters; dirty tree at attempt start is normal, restore pops only onto clean
