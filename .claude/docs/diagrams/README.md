...
| 04  | [AI session data flow](./04-ai-session-data-flow.md) | The file-based signals contract: prompt in, `signals.json` out, sidecars rendered — and `evaluation.md` read back by the CLI/TUI operator surfaces. |
