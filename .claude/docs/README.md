...
| [WORKFLOWS.md](./WORKFLOWS.md)                       | Sprint lifecycle + state table, two-phase planning, gen-eval loop, TUI navigation, setup/verify, branch management                                                                                                                              |
| [AI-SETTINGS.md](./AI-SETTINGS.md)                   | `settings.ai` shape, effort resolution, presets, per-provider model catalogs, fail-fast PATH check                                                                                                                                              |
| [SECURITY.md](./SECURITY.md)                         | Permission model, cross-process lock, spawning rules, the `AbortError` rule, skills, refine write-back, file-based provider contract                                                                                                            |
| [PERFORMANCE.md](./PERFORMANCE.md)                   | Scheduler / parallel waves, rate-limit retry, iteration budget, plateau escalation, progress journal, learning ledger, env vars, release procedure                                                                                              |
...
| WORKFLOWS.md            | Working on the sprint / task lifecycle, planning, the gen-eval loop, branch management, or TUI navigation                                    |
| AI-SETTINGS.md          | Changing provider / model / effort defaults, presets, or the `settings.ai` schema                                                            |
| SECURITY.md             | Touching permissions, spawning, the cross-process lock, skills install, refine write-back, or the provider contract                          |
| PERFORMANCE.md          | Tuning the scheduler / parallel waves, retries, iteration budget, journals / ledger, env vars, or running the release procedure              |
