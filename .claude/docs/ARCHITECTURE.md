...
| Pipeline                                                                                                         | Steps                                                                                                                                                                                                     |
| ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Refine](./seq-refine.puml)                                                                                      | `load-sprint → assert-draft → link-skills → refine-tickets → export-requirements → cleanup-skills`                                                                                                        |
| [Plan](./seq-plan.puml)                                                                                          | `load-sprint → assert-draft → assert-all-approved → link-skills → run-plan → reorder-dependencies → cleanup-skills`                                                                                       |
...
| [Execute (outer)](./seq-execute.puml)                                                                            | `load-sprint → check-preconditions → resolve-branch → auto-activate → assert-active → prepare-tasks → ensure-branches → run-check-scripts → link-skills → execute-tasks → feedback-loop → cleanup-skills` |
