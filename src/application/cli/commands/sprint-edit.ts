...
import { EditSprintUseCase } from '@src/business/usecases/sprint/edit-sprint.ts';
...
async function runSprintEdit(deps: SharedDeps, opts: SprintEditFlags): Promise<ExitCode> {
  return runCommand({
    deps,
    body: async () => {
