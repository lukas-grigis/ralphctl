 ...
 * previous selection.
 *
 * Three functions; no persistence (clears on process restart). Module-level
 * variable so it survives across renders but not across app restarts.
 */
...
/** Reset — used in tests and by the router when Home is re-mounted. */
