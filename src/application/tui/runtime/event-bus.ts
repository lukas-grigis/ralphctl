 ...
 *
 * Ported from src/integration/ui/tui/runtime/event-bus.ts — no legacy src/ imports.
 */

import { InMemoryLogEventBus } from '../../../integration/logging/log-event-bus.ts';

export type { LogEvent, LogEventBus } from '../../../integration/logging/log-event-bus.ts';
