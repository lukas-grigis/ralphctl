...
import { isSeparator, type Choice, type MenuItem, type SubMenu } from '@src/application/tui/views/menu-builder.ts';
import { actionKey, type MenuAction } from '@src/application/tui/views/menu-action.ts';
