...
import type { SubMenu } from '@src/application/tui/views/menu-builder.ts';
import type { MenuAction } from '@src/application/tui/views/menu-action.ts';
import { actionKey } from '@src/application/tui/views/menu-action.ts';
