import type { ChainTrace, ChainTraceEntry, Element, KernelError } from '../chain/element.ts';
...
export class ChainRunner<TCtx> {
  ...
  private async run(): Promise<void> {
    ...
    const result = await this.element.execute(this.currentCtx, this.abortController.signal, onTrace);
