 ...
 *    list 200 000 tokens for the 4.x line (Haiku 4.5 / Sonnet 4.6 / Opus 4.8). The fable-5
 *    tier (`claude-fable-5`, `claude-fable-5[1m]`) has no published window figure yet —
 *    omitted, so the TUI renders raw counts until Anthropic documents it.
