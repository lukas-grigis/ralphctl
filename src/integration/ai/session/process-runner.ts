 ...
 * grace period before escalating to `SIGKILL`. Same machinery the legacy
...
export const ABORT_GRACE_MS = 3000;

/** Hard cap on captured stdout, in bytes (matches legacy adapter). */
