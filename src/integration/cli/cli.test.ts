...
describe('Project Service', () => {
  it('creates and lists projects', async () => {
    const { listProjects, createProject, getProject } = await import('@src/integration/persistence/project.ts');
  ...
  it('adds and removes repos from project', async () => {
    const { addProjectRepo, removeProjectRepo, getProject, ProjectNotFoundError } =
      await import('@src/integration/persistence/project.ts');
  ...
  it('validates paths exist', async () => {
    const { addProjectRepo } = await import('@src/integration/persistence/project.ts');
...
describe('Sprint Service', () => {
  it('creates, activates, and closes sprint', async () => {
    ...
    const { createSprint, getSprint, activateSprint, closeSprint } =
      await import('@src/integration/persistence/sprint.ts');
...
describe('Error Handling', () => {
  it('throws on sprint not found', async () => {
    const { getSprint, SprintNotFoundError } = await import('@src/integration/persistence/sprint.ts');
